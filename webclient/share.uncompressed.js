...
(function() {
  var Connection, Doc, MicroEvent, ReconnectingWebSocket, SockJS, WebSocket, append, bootstrapTransform, checkValidComponent, checkValidOp, exports, hasBCSocket, hasSockJS, invertComponent, nextTick, socketImpl, strInject, text, transformComponent, transformPosition, types,
    __slice = [].slice,
  ...
  if (typeof WEB !== "undefined" && WEB !== null) {
    types = exports.types;
    SockJS = window.SockJS, WebSocket = window.WebSocket;
    if (SockJS) {
      socketImpl = 'sockjs';
    } else {
